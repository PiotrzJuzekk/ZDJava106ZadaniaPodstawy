...
public class Task3 {
    public static void main(String[] args) {
        ...
        System.out.println("If y++ is smaller than ++x and --x is smaller: " + pointC);

        boolean pointD = methodForPointD(x, y);
        System.out.println("If y++ is smaller than ++x and --x is smaller: " + pointD);
    }
    private static boolean comparison(int x, int y) {
        return x > y;
    }
